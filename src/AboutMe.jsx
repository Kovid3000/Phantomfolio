...
const REVEAL_CONTENT = [
  {
    upper: ["name: KD (Kovid Dutt Sharma)", "age: 19 (still debugging life)"],
    lower: "focus: biotechnology basics + coding basics",
  },
  {
    upper: [
      "Favorite anime: Attack on Titan, Neon Genesis Evangelion, Cowboy Bebop",
      "Digging into AI tools and how they actually work under the hood",
      "Learning Google Cloud through the Google AI Arcade program",
    ],
    lower: "a few fun facts about KD",
  },
  {
    upper: [
      "Runs small daily coding sessions to sharpen problem-solving",
      "Studying biotechnology basics alongside coding fundamentals",
      "Hindi music is the go-to soundtrack for focus",
    ],
    lower: "more about how KD spends the day",
  },
];
...
const ITEMS = [
  {
    id: "profile", label: "ABOUT ME", handle: "KD", href: "https://github.com/Kovid3000", icon: "🧬", barIcon: icon1, bars: 1, newBars: [0], counts: ["1"],
    links: ["github.com/Kovid3000"],
    stats: [
  ...
  {
    id: "facts1", label: "FUN FACT ABOUT ME", handle: "@kovidduttsharma", href: "https://www.instagram.com/kovidduttsharma/", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    links: ["instagram.com/kovidduttsharma"],
    stats: [
  ...
  {
    id: "facts2", label: "WIRED FACT ABOUT ME", handle: "Kovid Dutt Sharma", href: "https://www.linkedin.com/in/kovid-dutt-sharma-4576793a7", icon: "🎧", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
    links: ["www.linkedin.com/in/kovid-dutt-sharma-4576793a7"],
    stats: [
