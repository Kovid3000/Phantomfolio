...
const SKILLS_ROWS = [
  { index: "01", title: "Python & Java", status: "Proficient" },
  { index: "02", title: "SQL / MySQL", status: "Proficient" },
  { index: "03", title: "Backend Development", status: "Practicing" },
  { index: "04", title: "AI Tools & ML", status: "Learning" },
];

const PROJECTS_ROWS = [
  { index: "01", title: "Breaking Bad Portfolio", status: "Live" },
  { index: "02", title: "Google AI Arcade Profile", status: "Active" },
];

const EXPERIENCE_ROWS = [
  { index: "01", title: "Self-Directed Coding Sessions", status: "Ongoing" },
  { index: "02", title: "Google AI Arcade Program", status: "Participant" },
];

export default function ResumePage({ src, srcWebm }) {
  ...
  return (
    <div id="menu-screen">
      ...
      <div className="resume-entry-mask" aria-hidden="true">
        <video className="resume-entry-video" autoPlay loop muted playsInline>
          {srcWebm && <source src={srcWebm} type="video/webm" />}
          <source src={src} type="video/mp4" />
        </video>
      </div>
        ...
        {active === 1 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">SKILL LOG</div>
            ...
            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">DETAILS</div>
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- Video and photo editing for content creation.</div>
                <div className="resume-detail-bullet">- Learning Japanese and German alongside coding.</div>
                <div className="resume-detail-bullet">- Exploring Google Cloud templates via AI Arcade.</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 2 && (
          <div className="resume-detail-panel">
            ...
            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">DETAILS</div>
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- Breaking Bad-themed portfolio hosted on GitHub Pages.</div>
                <div className="resume-detail-bullet">- Building Phantomfolio, a Persona-styled portfolio site.</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 3 && (
          <div className="resume-detail-panel">
            ...
            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">DETAILS</div>
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- Runs small daily coding sessions to build consistency.</div>
                <div className="resume-detail-bullet">- Participating in the Google AI Arcade cloud program.</div>
              </div>
            </div>
          </div>
        )}
