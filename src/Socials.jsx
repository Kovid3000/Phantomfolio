...
const ITEMS = [
  {
    id: "instagram", label: "INSTAGRAM", handle: "@kovidduttsharma", href: "https://www.instagram.com/kovidduttsharma/", icon: "📷", barIcon: icon1, bars: 1, newBars: [0], counts: ["→"],
    links: ["instagram.com/kovidduttsharma"],
    stats: [
      { tag: "IG",  value: "OPEN", color: "#e1306c" },
      { tag: "PIC", value: "VIEW", color: "#f77737" },
    ],
  },
  {
    id: "github", label: "GITHUB", handle: "Kovid3000", href: "https://github.com/Kovid3000", icon: "💻", barIcon: icon2, bars: 1, newBars: [0], counts: ["→"],
    links: ["github.com/Kovid3000"],
    stats: [
      { tag: "GH",  value: "CODE", color: "#8fa1ff" },
      { tag: "REPO",value: "VIEW", color: "#c9d3ff" },
    ],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "Kovid Dutt Sharma", href: "https://www.linkedin.com/in/kovid-dutt-sharma-4576793a7", icon: "💼", barIcon: icon3, bars: 1, newBars: [0], counts: ["→"],
    links: ["www.linkedin.com/in/kovid-dutt-sharma-4576793a7"],
    stats: [
      { tag: "IN",  value: "LINK", color: "#0a66c2" },
      { tag: "PRO", value: "VIEW", color: "#70b5f9" },
    ],
  },
];
